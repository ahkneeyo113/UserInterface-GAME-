...
this._myWindow.refresh();
 ...
 function My_Window() {
    ...
    My_Window.prototype.initialize = function(x, y) {
      Window_Base.prototype.initialize.call(this, 670, 520, this.windowWidth(), this.windowHeight());
this._value = -1;
this.refresh();
    };
...
My_Window.prototype.refresh = function(){
      ...
      this.contents.clear();
    this.drawActorHp($gameParty.leader(), 0, -5, 100)
    this.drawActorMp($gameParty.leader(), 0, 25, 100)
